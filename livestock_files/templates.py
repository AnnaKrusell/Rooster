...
def pick_template(template_name, path):
    ...
    elif template_name == 'Rooster_v_boost_template':
        Rooster_v_boost_template(path)

    elif template_name == 'Rooster_boost_model_gen_template':
        Rooster_boost_model_gen_template(path)
    
    elif template_name == 'Rooster_datagen_template':
        Rooster_datagen_template(path)

    elif template_name == 'Rooster_modelgen_template':
        Rooster_modelgen_template(path)
...
def Rooster_v_boost_template(path):
    
    file_name = r'/Rooster_v_boost_template.py'
    ...
    file.write("ls.Rooster_v_boost_function(r'" + path + "')\n")
...
def Rooster_boost_model_gen_template(path):
    
    file_name = r'/Rooster_boost_model_gen_template.py'
    file = open(path + file_name, 'w')
    ...
    file.write("# Run function\n")
    file.write("ls.Rooster_boost_model_gen_function(r'" + path + "')\n")
...
def Rooster_datagen_template(path):
    
    file_name = r'/Rooster_datagen_template.py'
    file = open(path + file_name, 'w')
    ...
    file.write("# Run function\n")
    file.write("ls.Rooster_datagen_function(r'" + path + "')\n")
...
def Rooster_modelgen_template(path):
    
    file_name = r'/Rooster_modelgen_template.py'
    file = open(path + file_name, 'w')
    ...
    file.write("# Run function\n")
    file.write("ls.Rooster_modelgen_function(r'" + path + "')\n")
